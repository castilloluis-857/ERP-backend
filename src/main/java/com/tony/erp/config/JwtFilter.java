 ...
 * Spring Security se encargará de rechazarla si la ruta lo requiere.package com.tony.erp.config;
...
/**
 * Filtro JWT que valida el token en cada petición y registra al usuario
 * en el contexto de Spring Security si el token es válido.
 */
@Component
